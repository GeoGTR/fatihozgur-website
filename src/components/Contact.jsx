...
const Contact = () => {
  return (
    <div name='contact' className='w-full h-screen bg-[#0a192f] flex justify-center items-center p-4'>
        <form method='POST' action="https://getform.io/f/7f9854fd-a1b6-4e1e-8153-b0ee65ec4459" className='flex flex-col max-w-[600px] w-full'>
            <div className='pb-8'>
                ...
                <p className='text-gray-300 py-4'>Submit the form below or send me an email - 
                    <span className='inline border-b-2 border-blue-600'>fatihozgurcmpe@gmail.com</span> 
                </p>
            </div>
